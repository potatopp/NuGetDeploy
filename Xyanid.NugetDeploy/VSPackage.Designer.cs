...
namespace Xyanid.VisualStudioExtension.NuGetDeploy {
    ...
    internal class VSPackage {
        ...
        /// <summary>
        ///   查找类似 NuGetExePath and RepoInfos 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Lets you deploy NuGet packages straight from visual studio via a right click command 的本地化字符串。
        /// </summary>
